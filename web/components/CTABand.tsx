  ...
  return (
    <section className="bg-ink py-16 sm:py-20">
      <div className="container-page">
        <div className="card-dark flex flex-col items-center gap-8 rounded-2xl border-white/10 bg-navy-800 px-6 py-10 text-center sm:px-10 lg:flex-row lg:text-left">
          ...
          <div className="flex-1">
            ...
            <div className="mt-4 flex flex-wrap justify-center gap-x-5 gap-y-1.5 text-xs text-mist lg:justify-start">
          ...
          <Link
            href="/#scan"
            className="btn-gradient focus-ring flex shrink-0 items-center gap-2 rounded-xl px-6 py-3.5 text-sm"
          >
            {buttonLabel}
            <ArrowRight size={16} />
          </Link>
